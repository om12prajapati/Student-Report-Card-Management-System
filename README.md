...
Build a real time student search feature, Designed automated grade and percentage Calulatation.
#include <iostream>
#include <fstream>
#include <string>
#include <iomanip>
...
void displayMenu() {
    cout << "Display Student Phone number";
...
int main() {
    ...
    system.loadFromFile(); // Load existing data at startup
